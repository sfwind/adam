 ...
 */
package com.dianping.ba.es.qyweixin.adapter.biz.aes;
...
public class Prpcrypt {
    ...
    public Prpcrypt(String encodingAesKey) throws Exception {
     ...
     */
    public Result encrypt(String text, String appid) throws UnsupportedEncodingException {
        ...
        try {
            DisableKeySizeRestriction.removeCryptographyRestrictions();
            // 设置加密模式为AES的CBC模式
